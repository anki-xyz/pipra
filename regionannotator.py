from PyQt5.QtWidgets import QApplication, QMainWindow, QWidget, QGridLayout, QSlider, QLabel, QFileDialog, QColorDialog, QMessageBox
    ...
    def paint(self, forcePaint=False):
        ...
        if self.maskItem.clicked or forcePaint:
            ...
            if modifiers == Qt.ControlModifier:
                f = floodfill(self.getImageItem().image,
                              (int(xy.x()),
                               int(xy.y())))
...
class Main(QMainWindow):
    ...
    def open(self, file=None, file_avi=None):
        # A video is loaded
        ...
        if file:
            ...
            self.stack = Stack(s[..., 0] if len(s.shape) == 4 else s, mask)
